...
public class SmallPhoto {
    ...
    public @Nullable String bytesToBase64String() {
        if (photo != null) {
            try {
                String base64Image = photo.split(",")[1];

                try (
                        ByteArrayInputStream is = new ByteArrayInputStream(Base64.getDecoder().decode(base64Image));
                    ...
                    return "data:image/" + outputFormat + ";base64," +
